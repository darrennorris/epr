...
```{r fig-r-dados-tidy, echo=FALSE, fig.cap="As três regras que tornam um conjunto de dados *tidy*."}
...
```{r fig-r-join, echo=FALSE, fig.cap="Diferentes tipos de joins, representados com um diagrama de Venn."}
...
```{r fig-hist-flipper, eval = FALSE, out.width = "75%", out.height = "75%", fig.cap = "Histograma da variável comprimento_nadadeira."}
...
```{r fig-hist-bins, out.width="75%", out.height="75%", fig.cap="Histograma de comprimento_nadadeira para diferentes classes."}
...
```{r fig-hist-cat, out.width = "75%", out.height = "75%", fig.cap="Histograma da variável comprimento_nadadeira para diferentes espécies com e sem sobreposição."}
...
```{r fig-hist-fino, out.width = "75%", out.height = "75%", fig.cap="Histograma da variável comprimento_nadadeira com ajustes finos."}
## Histograma exemplo
