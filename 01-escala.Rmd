...
```{r raster-res, echo = FALSE, fig.align = 'center', out.width = "60%", out.height = "60%", fig.cap=" Comparação de tamanhos de pixels pequenos e grandes. Mostrando diferenças causadas pela agregação de 4 pixels em 1."}
