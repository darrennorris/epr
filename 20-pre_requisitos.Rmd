...
```{r fig-r-instalacao, out.width = "55%", out.height = "55%", echo = FALSE, fig.cap = "Esquema ilustrativo demonstrando os passos necessários para instalação do programa R no computador. "}
...
```{r fig-rstudio-instalacao, out.width = "55%", out.height = "55%", echo = FALSE, fig.cap = "Esquema ilustrativo demonstrando os passos necessários para instalação do programa RStudio no computador."}
