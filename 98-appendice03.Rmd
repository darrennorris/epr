...
bind_rows( 
  ...
  PA.points.sppK$sample.points |> mutate(sp = "sppK"), 
  PA.points.sppL$sample.points |> mutate(sp = "sppL"), 
  PA.points.sppM$sample.points |> mutate(sp = "sppM"),
  PA.points.sppN$sample.points |> mutate(sp = "sppN")
  ) -> species_points
