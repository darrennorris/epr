...
# Mudanças na cobertura vegetal nativa {#cap11}
...
#### Taxa de mudanças
Taxa de desmatamento (área desmatada por km^2^). Devido ao fato da resolução espacial do mapa binário de desmatamento ser de `r round(xres(f86), 1)` metros, as células correspondem a `r round((xres(f86) * yres(f86)) / 10000, 1)` ha. Assim, é necessário multiplicar a soma das células por `r round((xres(f86) * yres(f86)) / 10000, 1)`, para obtenção de um mapa indicativo da quantidade de hectares desmatados por km^2^.
