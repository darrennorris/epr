...
`mutate()` é uma função muito versátil que pode ser usada para criar, modificar e excluir colunas em um quadro de dados (data frame). Mais exemplos com o uso de `mutate()` [aqui:](https://analises-ecologicas.com/cap5#mutate) https://analises-ecologicas.com/cap5#mutate.
