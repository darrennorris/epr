...
```{r fig-rgui, echo=FALSE, out.width = "55%", out.height = "55%", fig.cap="Interface do RGui. Os números indicam: (1) R Script, (2) R Console, e (3) R Graphics."}
